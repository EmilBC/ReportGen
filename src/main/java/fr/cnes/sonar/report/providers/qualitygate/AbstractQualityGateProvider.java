...
public abstract class AbstractQualityGateProvider extends AbstractDataProvider {
    ...
    protected QualityGate getProjectQualityGateAbstract()
        ...
        QualityGate tmp=new QualityGate();
        boolean find = false;
        final String key = "AYlEo0Ql0S8MdK3ohUdJ";//jsonObject.getAsJsonObject(QUALITY_GATE).get(KEY).getAsString();
...
tmp.setName("AYlEo0Ql0S8MdK3ohUdJ");
res=tmp;
find=true;
